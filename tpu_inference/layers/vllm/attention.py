...
import tokamax._src.ops.experimental.tpu.splash_attention.splash_attention_kernel as splash_attention_kernel
import tokamax._src.ops.experimental.tpu.splash_attention.splash_attention_mask as splash_attention_mask
import torch
...
def _jax_encoder_attn_func(
    ...
    *,
    ...
    def pad_token(tensor: jax.Array, size) -> jax.Array:
        # tensor is [num_head, token, head_dim]
        result = jnp.pad(tensor, ((0, 0), (0, size), (0, 0)),
                         constant_values=0)
        return result
    ...
    def build_segment_ids() -> jax.Array:
    ...
    mask = splash_attention_mask.FullMask((q_pad_seq_len, k_pad_seq_len))
