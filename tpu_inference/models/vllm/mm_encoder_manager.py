...
class MMEncoderManager:
    ...
    def __init__(
        ...
        token_budgets, max_batch_size = self.build_budgets_and_batch(
            vllm_config,
            model,
        )
        ...
        self.max_frames_per_batch = self.build_max_frames(
            vllm_config,
            self.max_batch_size,
            self.config,
        )
